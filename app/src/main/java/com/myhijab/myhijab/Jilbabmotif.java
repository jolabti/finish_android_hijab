...
public class Jilbabmotif extends AppCompatActivity {
    ...
    private final static String TAG = Jilbabmotif.class.getSimpleName();
    Config base_url = new Config();
    String url = base_url.getUrl()+"index.php/maincontroller/get_product_controller_jilbabmotif";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Jilbabmotif.this, hku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Jilbabmotif.this, DetailActivity.class);
    ...
    private void getDataFromInternet() {
        ...
        new GetJsonFromUrlTask3(this, url).execute();
    }
