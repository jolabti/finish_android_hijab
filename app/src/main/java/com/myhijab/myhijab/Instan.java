...
public class Instan extends AppCompatActivity {
    ...
    private final static String TAG = Instan.class.getSimpleName();
    Config base_url = new Config();
    String url = base_url.getUrl()+"index.php/maincontroller/get_product_controller_instan";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Instan.this, hku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Instan.this, DetailActivity.class);
    ...
    public void parseJsonResponse(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                book.setImgUrl(base_url.getUrl()+"media/" + jObject.getString("urlimage"));
                book.setKodeHijab(jObject.getString("kd_hijab"));
                books.add(book);
            }
