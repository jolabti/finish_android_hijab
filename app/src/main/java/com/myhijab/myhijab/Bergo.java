...
public class Bergo extends AppCompatActivity {
    ...
    private final static String TAG = Bergo.class.getSimpleName();
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Bergo.this, hku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Bergo.this, DetailActivity.class);
