...
public class Pashmina extends AppCompatActivity {
    ...
    private final static String TAG = Pashmina.class.getSimpleName();
    Config base_url = new Config();
    String url = base_url.getUrl()+"index.php/maincontroller/get_product_controller_pashmina";
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                try {
                    ...
                    Toast.makeText(Pashmina.this, hku_name + " is created by " + lain, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Pashmina.this, DetailActivity.class);
                    intent.putExtra("name", hku_name);
    ...
    private void getDataFromInternet() {
        ...
        new GetJsonFromUrlTask4(this, url).execute();
    }
    ...
    public void parseJsonResponse(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                book.setImgUrl("http://192.168.1.15/hijabadmin/media/" + jObject.getString("urlimage"));
                book.setKodeHijab(jObject.getString("kd_hijab"));
                books.add(book);
            }
